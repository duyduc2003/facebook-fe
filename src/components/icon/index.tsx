...
export const Icon9Dot = ({ fill }: IconProps) => (
  <svg fill={fill || 'currentColor'} viewBox="0 0 44 44" width="20" height="20">
...
export const IconPeopleGroupFill = () => (
  <svg viewBox="0 0 28 28" fill="currentColor" height="28" width="28">
...
export const IconPost = () => (
  <i
    style={{
      backgroundImage: `url(${IconImg1.src})`,
      backgroundPosition: '0px -503px',
      backgroundSize: '25px 1448px',
      width: '20px',
      height: '20px',
...
export const IconBook = () => (
  <i
    style={{
      backgroundImage: `url(${IconImg2.src})`,
...
export const IconPeopleGroupSmall = () => (
  <i
    style={{
      backgroundImage: `url(${IconImg2.src})`,
...
export const Icon3Dot = () => (
  <i
    style={{
      backgroundImage: `url(${IconImg3.src})`,
...
export const IconOpenMessage = () => (
  <i
    style={{
      backgroundImage: `url(${IconImg4.src})`,
      backgroundPosition: '0px -652px',
      backgroundSize: '38px 812px',
      width: '20px',
      height: '20px',
      backgroundRepeat: 'no-repeat',
      display: 'inline-block',
...
export const IconPostSmall = () => (
  <i
    style={{
      backgroundImage: `url(${IconImg5.src})`,
      backgroundPosition: '2px -1252px',
      backgroundSize: '26px 1476px',
      width: '20px',
      height: '20px',
      backgroundRepeat: 'no-repeat',
      display: 'inline-block',
...
export const IconSetting = () => (
  <i
    style={{
      backgroundImage: `url(${IconImg6.src})`,
...
export const IconFacebookLarge = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    id="Layer_1"
    data-name="Layer 1"
    viewBox="0 0 1022.51 360"
  >
    <defs></defs>
    <title>FBWordmark_Hex-RGB-1024</title>
    <path
      className="cls-1 fill-[#1877F2]"
